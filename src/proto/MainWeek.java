 ...
 * @author adg19f
 */
public class MainWeek extends javax.swing.JFrame {

    /**
     * Creates new form MainWeek
     */
    public MainWeek() {
        initComponents();
    }
    
    public MainWeek(String user){
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainWeek.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

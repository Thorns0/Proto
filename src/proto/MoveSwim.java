 ...
 * @author adg19f
 */
public class MoveSwim extends javax.swing.JFrame {

    /**
     * Creates new form MoveSwim
     */
    public MoveSwim() {
        initComponents();
    }
    
    public MoveSwim(String user){
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MoveSwim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

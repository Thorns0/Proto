 ...
 * @author adg19f
 */
public class MainSwimmer extends javax.swing.JFrame {

    /**
     * Creates new form MainSwimmer
     */
    public MainSwimmer() {
        initComponents();
    }
    
    public MainSwimmer(String user){
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainSwimmer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainSwimmer().setVisible(true);
            }
        });
    }
